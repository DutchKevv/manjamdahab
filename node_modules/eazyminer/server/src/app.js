...
module.exports = class App {
    ...
    _setupWebServer() {
        ...
        var server = this._app.listen(this.config.web.port, this.config.web.host, () => {
            this.logger.info(`Web app listening at http://${this.config.web.host}:${this.config.web.port}`)
        });
    }
}